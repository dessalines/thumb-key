...
val KB_HR_THUMBKEY_SYMBOLS_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_HR_THUMBKEY_SYMBOLS_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_HR_THUMBKEY_SYMBOLS: KeyboardDefinition = KeyboardDefinition(
    title = "HR Thumb-Key hrvatski symbols",
