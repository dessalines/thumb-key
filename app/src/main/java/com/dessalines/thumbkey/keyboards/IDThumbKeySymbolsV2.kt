...
val KB_ID_THUMBKEY_SYMBOLS_V2_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ID_THUMBKEY_SYMBOLS_V2_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ID_THUMBKEY_SYMBOLS_V2: KeyboardDefinition = KeyboardDefinition(
    title = "ID Thumb-Key Bahasa Indonesia symbols v2",
