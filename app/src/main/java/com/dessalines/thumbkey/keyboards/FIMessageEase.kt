...
val KB_FI_MESSAGEEASE: KeyboardDefinition =
    KeyboardDefinition(
        title = "suomi messageease",
        modes =
            KeyboardDefinitionModes(
                main = KB_FI_MESSAGEEASE_MAIN,
                shifted = KB_FI_MESSAGEEASE_SHIFTED,
