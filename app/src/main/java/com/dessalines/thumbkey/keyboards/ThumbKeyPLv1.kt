...
val THUMBKEY_PL_V1_MAIN = KeyboardC(
    arrayOf(
        arrayOf(
            KeyItemC(
                center = KeyC(
...
val THUMBKEY_PL_V1_SHIFTED = KeyboardC(
    arrayOf(
        arrayOf(
            KeyItemC(
                center = KeyC(
...
val THUMBKEY_PL_V1_KEYBOARD_MODES: Map<KeyboardMode, KeyboardC> = mapOf(
    KeyboardMode.MAIN to THUMBKEY_PL_V1_MAIN,
    KeyboardMode.SHIFTED to THUMBKEY_PL_V1_SHIFTED,
