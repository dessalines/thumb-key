        ...
        listOf(
            listOf(
                ...
                KeyItemC(
                    ...
                    bottomRight = KeyC(KeyAction.CommitText("ø")),
                    topLeft = KeyC(KeyAction.CommitText("ò")),
                    topRight = KeyC(KeyAction.CommitText("ô")),
                ),
                EMOJI_KEY_ITEM,
            ),
            listOf(
            ...
            listOf(
                ...
                KeyItemC(
                    ...
                    topRight = KeyC(KeyAction.CommitText("æ")),
                    bottomLeft = KeyC(KeyAction.CommitText("é")),
                ),
                BACKSPACE_KEY_ITEM,
            ),
            listOf(
