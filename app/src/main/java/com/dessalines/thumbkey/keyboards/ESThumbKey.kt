...
val KB_ES_THUMBKEY_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ES_THUMBKEY_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ES_THUMBKEY: KeyboardDefinition = KeyboardDefinition(
    title = "ES Thumb-Key español",
