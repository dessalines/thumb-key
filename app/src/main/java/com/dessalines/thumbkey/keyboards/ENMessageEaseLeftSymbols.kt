...
val KB_EN_MESSAGEEASE_SYMBOLS_MAIN_LEFT =
    KeyboardC(
        listOf(
            listOf(
                EMOJI_KEY_ITEM,
...
val KB_EN_MESSAGEEASE_SYMBOLS_SHIFTED_LEFT =
    KeyboardC(
        listOf(
            listOf(
                EMOJI_KEY_ITEM,
...
val KB_EN_MESSAGEEASE_SYMBOLS_NUMBERS_LEFT =
    KeyboardC(
        listOf(
            listOf(
                EMOJI_KEY_ITEM,
    ...
    KeyboardDefinition(
        ...
        modes =
            KeyboardDefinitionModes(
                main = KB_EN_MESSAGEEASE_SYMBOLS_MAIN_LEFT,
                shifted = KB_EN_MESSAGEEASE_SYMBOLS_SHIFTED_LEFT,
                numeric = KB_EN_MESSAGEEASE_SYMBOLS_NUMBERS_LEFT,
            ),
        settings =
