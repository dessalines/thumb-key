...
val THUMBKEY_HR_V1_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val THUMBKEY_HR_V1_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val THUMBKEY_HR_V1_KEYBOARD_MODES: Map<KeyboardMode, KeyboardC> = mapOf(
    KeyboardMode.MAIN to THUMBKEY_HR_V1_MAIN,
    KeyboardMode.SHIFTED to THUMBKEY_HR_V1_SHIFTED,
    KeyboardMode.NUMERIC to NUMERIC_KEYBOARD,
)

val THUMBKEY_HR_V1_KEYBOARD_AUTOCAPITALIZERS: Autocapitalizers = arrayOf()
