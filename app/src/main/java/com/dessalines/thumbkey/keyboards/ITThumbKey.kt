...
val KB_IT_THUMBKEY_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_IT_THUMBKEY_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_IT_THUMBKEY: KeyboardDefinition = KeyboardDefinition(
    title = "IT Thumb-Key italiano",
