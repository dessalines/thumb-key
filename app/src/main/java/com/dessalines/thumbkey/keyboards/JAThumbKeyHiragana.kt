...
val KB_JA_THUMBKEY_HIRAGANA_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_JA_THUMBKEY_HIRAGANA_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_JA_THUMBKEY_HIRAGANA: KeyboardDefinition = KeyboardDefinition(
    title = "JA Thumb-Key japanese Hiragana",
