...
val KB_SK_THUMBKEY_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_SK_THUMBKEY_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_SK_THUMBKEY: KeyboardDefinition = KeyboardDefinition(
    title = "SK Thumb-Key slovenčina",
