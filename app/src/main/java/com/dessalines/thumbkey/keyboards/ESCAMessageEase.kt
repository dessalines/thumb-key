...
val KB_ES_CA_MESSAGEEASE_SHIFTED =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_ES_CA_MESSAGEEASE: KeyboardDefinition =
    KeyboardDefinition(
        title = "español català messageease",
        modes =
            KeyboardDefinitionModes(
                main = KB_ES_CA_MESSAGEEASE_MAIN,
                shifted = KB_ES_CA_MESSAGEEASE_SHIFTED,
