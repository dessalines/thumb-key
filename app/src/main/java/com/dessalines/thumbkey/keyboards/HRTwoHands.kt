...
val KB_HR_TWO_HANDS_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_HR_TWO_HANDS_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_HR_TWO_HANDS: KeyboardDefinition = KeyboardDefinition(
    title = "EN Two Hands hrvatski",
