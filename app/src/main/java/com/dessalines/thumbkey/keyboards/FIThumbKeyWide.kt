...
val KB_FI_THUMBKEY_WIDE_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FI_THUMBKEY_WIDE_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FI_THUMBKEY_WIDE: KeyboardDefinition = KeyboardDefinition(
    title = "FI Thumb-Key suomi wide",
