...
val KB_ES_MESSAGEEASE_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ES_MESSAGEEASE_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ES_MESSAGEEASE: KeyboardDefinition = KeyboardDefinition(
    title = "ES MessageEase español",
