...
val KB_FR_THUMBKEY_V2_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FR_THUMBKEY_V2_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FR_THUMBKEY_V2: KeyboardDefinition = KeyboardDefinition(
    title = "FR Thumb-Key français v2",
