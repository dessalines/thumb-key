...
val KB_NO_THUMBKEY_V1_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_NO_THUMBKEY_V1_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_NO_THUMBKEY_V1: KeyboardDefinition = KeyboardDefinition(
    title = "NO Thumb-Key norsk v1",
    modes = KeyboardDefinitionModes (
        main = KB_NO_THUMBKEY_V1_MAIN,
        shifted = KB_NO_THUMBKEY_V1_SHIFTED,
