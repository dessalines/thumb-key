...
val KB_DE_THUMBKEY_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_DE_THUMBKEY_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_DE_THUMBKEY: KeyboardDefinition = KeyboardDefinition(
    title = "DE Thumb-Key deutch",
