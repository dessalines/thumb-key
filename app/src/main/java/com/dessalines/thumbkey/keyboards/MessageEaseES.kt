...
val MESSAGEEASE_ES_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val MESSAGEEASE_ES_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val MESSAGEEASE_ES_KEYBOARD_MODES: Map<KeyboardMode, KeyboardC> = mapOf(
    KeyboardMode.MAIN to MESSAGEEASE_ES_MAIN,
    KeyboardMode.SHIFTED to MESSAGEEASE_ES_SHIFTED,
    KeyboardMode.NUMERIC to NUMERIC_KEYBOARD,
)

val MESSAGEEASE_ES_KEYBOARD_AUTOCAPITALIZERS: Autocapitalizers = arrayOf()
