...
val THUMBKEY_BG_V1_SYMBOLS_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val THUMBKEY_BG_V1_SYMBOLS_KEYBOARD_MODES: Map<KeyboardMode, KeyboardC> = mapOf(
    KeyboardMode.MAIN to THUMBKEY_BG_V1_SYMBOLS,
    KeyboardMode.SHIFTED to THUMBKEY_BG_V1_SYMBOLS_SHIFTED,
    KeyboardMode.NUMERIC to NUMERIC_KEYBOARD,
)

val THUMBKEY_BG_V1_SYMBOLS_KEYBOARD_AUTOCAPITALIZERS: AutoCapitalizers = arrayOf()
