...
val KB_EN_THUMBKEY_MULTI_IT_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_EN_THUMBKEY_MULTI_IT_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_EN_THUMBKEY_MULTI_IT: KeyboardDefinition = KeyboardDefinition(
    title = "EN Thumb-Key english (EN+IT multi)",
    modes = KeyboardDefinitionModes(
        main = KB_EN_THUMBKEY_MULTI_IT_MAIN,
        shifted = KB_EN_THUMBKEY_MULTI_IT_SHIFTED,
