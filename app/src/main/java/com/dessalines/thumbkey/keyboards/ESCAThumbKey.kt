...
val KB_ES_CA_THUMBKEY_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ES_CA_THUMBKEY_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ES_CA_THUMBKEY: KeyboardDefinition = KeyboardDefinition(
    title = "ESCA Thumb-Key español català",
