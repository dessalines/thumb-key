        ...
        listOf(
            listOf(
                ...
                KeyItemC(
                    ...
                    right = KeyC("G"),
                    left = KeyC("H"),
                    bottom = KeyC("Gh", capsModeDisplay = KeyDisplay.TextDisplay("GH"), color = MUTED),
                    top = KeyC("F"),
                ),
                EMOJI_KEY_ITEM_ALT,
                KeyItemC(
            ...
            listOf(
                ...
                KeyItemC(
                    ...
                    swipeType = TWO_WAY_HORIZONTAL,
                    right = KeyC("Ù", color = MUTED),
                    left = KeyC("Qu", capsModeDisplay = KeyDisplay.TextDisplay("QU"), color = MUTED),
                ),
                KeyItemC(
                    center = KeyC("A", size = LARGE),
                    swipeType = TWO_WAY_HORIZONTAL,
            ...
            listOf(
                ...
                KeyItemC(
                    ...
                    right = KeyC("D"),
                    left = KeyC("B"),
                    bottom = KeyC("Ch", capsModeDisplay = KeyDisplay.TextDisplay("CH"), color = MUTED),
                    top = KeyC("K"),
                ),
                SPACEBAR_TYPESPLIT_BOTTOM_KEY_ITEM,
                KeyItemC(
