...
val KB_EN_MESSAGEEASE_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_EN_MESSAGEEASE_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_EN_MESSAGEEASE: KeyboardDefinition = KeyboardDefinition(
    title = "EN MessageEase english",
