...
val KB_FR_MESSAGEEASE_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FR_MESSAGEEASE_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FR_MESSAGEEASE: KeyboardDefinition = KeyboardDefinition(
    title = "FR MessageEase français",
