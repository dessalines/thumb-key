...
val KB_DE_TYPESPLIT_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_DE_TYPESPLIT_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_DE_TYPESPLIT: KeyboardDefinition = KeyboardDefinition(
    title = "DE Type-Split deutsch",
