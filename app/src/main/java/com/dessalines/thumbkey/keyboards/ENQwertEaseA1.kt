...
val KB_EN_QWERTEASE_ALPHANUMERIC_MAIN =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_EN_QWERTEASE_ALPHANUMERIC_SHIFTED =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_EN_QWERTEASE: KeyboardDefinition =
    KeyboardDefinition(
        title = "english qwertease a1",
        modes =
            KeyboardDefinitionModes(
                main = KB_EN_QWERTEASE_ALPHANUMERIC_MAIN,
                shifted = KB_EN_QWERTEASE_ALPHANUMERIC_SHIFTED,
