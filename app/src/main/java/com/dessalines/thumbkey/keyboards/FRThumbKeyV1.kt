...
val KB_FR_THUMBKEY_V1_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FR_THUMBKEY_V1_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_FR_THUMBKEY_V1: KeyboardDefinition = KeyboardDefinition(
    title = "FR Thumb-Key français v1",
