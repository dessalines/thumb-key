...
val KB_EN_THUMBKEY_SYMBOLS_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_EN_THUMBKEY_SYMBOLS_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_EN_THUMBKEY_SYMBOLS: KeyboardDefinition = KeyboardDefinition(
    title = "EN Thumb-Key english symbols",
