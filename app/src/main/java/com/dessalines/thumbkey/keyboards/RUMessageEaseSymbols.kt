...
val KB_RU_MESSAGEEASE_SYMBOLS_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_RU_MESSAGEEASE_SYMBOLS_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_RU_MESSAGEEASE_SYMBOLS: KeyboardDefinition = KeyboardDefinition(
    title = "RU MessageEase русский with symbols",
    modes = KeyboardDefinitionModes(
        main = KB_RU_MESSAGEEASE_SYMBOLS_MAIN,
        shifted = KB_RU_MESSAGEEASE_SYMBOLS_SHIFTED,
