...
val KB_ID_THUMBKEY_SYMBOLS_V1_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ID_THUMBKEY_SYMBOLS_V1_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_ID_THUMBKEY_SYMBOLS_V1: KeyboardDefinition = KeyboardDefinition(
    title = "ID Thumb-Key Bahasa Indonesia symbols v1",
