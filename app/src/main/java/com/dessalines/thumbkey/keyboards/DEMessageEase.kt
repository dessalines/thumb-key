...
val KB_DE_MESSAGEEASE_NUMERIC_KEY_ITEM =
    KeyItemC(
        center =
            KeyC(
...
val KB_DE_MESSAGEEASE_EMOJI_KEY_ITEM =
    KeyItemC(
        center =
            KeyC(
...
val KB_DE_MESSAGEEASE_RETURN_KEY_ITEM =
    KeyItemC(
        center =
            KeyC(
    ...
    KeyboardC(
        listOf(
            listOf(
                ...
                KB_DE_MESSAGEEASE_EMOJI_KEY_ITEM,
            ),
            listOf(
                KeyItemC(
                    center =
                ...
                KB_DE_MESSAGEEASE_NUMERIC_KEY_ITEM,
            ),
            listOf(
                KeyItemC(
                    center =
            ...
            listOf(
                SPACEBAR_KEY_ITEM,
                KB_DE_MESSAGEEASE_RETURN_KEY_ITEM,
            ),
        ),
    )

val KB_DE_MESSAGEEASE_SHIFTED =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_DE_MESSAGEEASE_NUMERIC_KEYBOARD =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_DE_MESSAGEEASE: KeyboardDefinition =
    KeyboardDefinition(
        title = "deutsch messagease",
        modes =
            KeyboardDefinitionModes(
                main = KB_DE_MESSAGEEASE_MAIN,
                shifted = KB_DE_MESSAGEEASE_SHIFTED,
                numeric = KB_DE_MESSAGEEASE_NUMERIC_KEYBOARD,
            ),
    )
