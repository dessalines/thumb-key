...
val KB_DE_MESSAGEEASE_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_DE_MESSAGEEASE_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_DE_MESSAGEEASE: KeyboardDefinition = KeyboardDefinition(
    title = "DE MessageEase deutch",
