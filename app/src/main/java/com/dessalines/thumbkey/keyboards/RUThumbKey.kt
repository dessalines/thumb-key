...
val KB_RU_THUMBKEY_MAIN = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_RU_THUMBKEY_SHIFTED = KeyboardC(
    listOf(
        listOf(
            KeyItemC(
                center = KeyC(
...
val KB_RU_THUMBKEY: KeyboardDefinition = KeyboardDefinition(
    title = "RU Thumb-Key русский",
