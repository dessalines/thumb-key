...
fun dracula(): Pair<ColorScheme, ColorScheme> {
    ...
    val md_theme_dark_primary = Color(0xFFF7F7F1) // Primary Legends
    ...
    val md_theme_dark_secondary = Color(0xFFBD93F9) // Secondary Legends
    ...
    val md_theme_dark_tertiaryContainer = Color(0xFFFEB76C) // key up
    ...
    val md_theme_dark_onSurface = Color(0xFFF8F8F2) // menu text
    val md_theme_dark_surfaceVariant = Color(0xFF44475A)
    val md_theme_dark_onSurfaceVariant = Color(0xFFFF79C6) // menu icons
    ...
    val md_theme_dark_inversePrimary = Color(0xFFF0F98B) // key down
    val md_theme_dark_shadow = Color(0xFF000000)
